                          ...
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <!-- <hr> -->
                              <thead>
                                <div class="row">
                                  <div class="col-md-12">
                                    <a href="<?php echo base_url(); ?>index.php/divisi/addDivisi"><button class="btn btn-success" onclick="" <?php if($this->session->userdata('role') != 'admin') echo "disabled" ?>><i class="fa fa-plus"></i> Add Divisi </button></a>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <a onclick="return confirm('delete this data ?');" href="<?php echo base_url();?>index.php/divisi/deleteDivisi/<?php echo $divisi->id_divisi; ?>"><button <?php if($this->session->userdata('role') != 'admin') echo "disabled" ?> class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                  </td>
                              </tr>
                              <?php } ;?>
                              </tbody>
